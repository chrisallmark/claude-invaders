...
export const ALIEN_H_SPACING = 12; // logical px between alien origins, horizontally
export const ALIEN_V_SPACING = 12; // logical px between alien origins, vertically
